...
uint8_t FileTextE104[30] = { 0x00, 0x16, /* NLEN; NDEF length (3 byte long message) */
		0xD1, 0x01, 0x12, 0x54, /* T = text */
		0x02, 0x65, 0x6E, /* 'e', 'n', */

		/* 'Hello, world!' NDEF data; */
		0x54, 0x65, 0x2E, 0x2E, 0x6f, 0x2c, 0x20, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x21
