...
uint8_t FileTextE104[15000] = { 0x00, 0x3A, /* NLEN; NDEF length (3 byte long message) */
		0xC1, 0x01,/*lenghth of four bytes */0x00, 0x00, 0x00, 0x33, 0x54, /* T = text */
		0x02, /*0x65, 0x6E,  'e', 'n', */

		'6','9','9','6','-','1','1','2','2',',',				//10
		'1','7','1','1','2','9',' ','1','8',':','5','1',',',	//13
		'B','u','r','g','e','r',' ','I','n',' ','n',' ','O','u','t',',',//16
		'M','e','a','l',' ','C','o','m','b','o','\n',			//11
